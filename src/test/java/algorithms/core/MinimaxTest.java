...
public class MinimaxTest {
    ...
    public void smallTree() {
        ...
        */
        ...
        assertEquals(nodesNoPruning,
                ExtendedGraphMock.getLastClosedNodes(),
                "Неверный перечень открытых вершин графа.");
    ...
    public void alphaBetaPruning() {
        ...
        */
        ...
        assertEquals(TestActions.CENTER,
                mmNoPruning.getMaximizingAction(mmGraph, 0),
                "Неверное действие.");
