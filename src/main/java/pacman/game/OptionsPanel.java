...
public class OptionsPanel extends JPanel {
    private static final String LOCALIZATION_FILE = "strings";
    ...
    public OptionsPanel(GameController controller) {
        ...
        ResourceBundle localization = ResourceBundle.getBundle(LOCALIZATION_FILE, Locale.getDefault());
        ...
        labelSelectControlMode.setText(localization.getString("start.control.yourself.question"));

        radioModeManual.setText(localization.getString("start.control.yourself.yes"));
        ...
        radioModeMinimax.setText(localization.getString("start.control.yourself.no.much"));
        ...
        radioModeReflex.setText(localization.getString("start.control.yourself.no.less"));
        radioModeReflex.setSelected(true);
        ...
        labelSelectGhostsNumber.setText(localization.getString("start.ghosts.number"));
        ...
        buttonStart.setText(localization.getString("start.run"));
